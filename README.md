...
## Comandos del bot
Documentación completa en: [docs/COMANDOS.md](docs/COMANDOS.md)

## Iconos de equipos LEC (opcional)

Si configuras `LEC_TEAM_EMOJIS`, los botones intentarán mostrar el emoji del equipo cuando la etiqueta coincida (p.ej. `G2`, `FNC`, etc.).

Ejemplo:

```env
LEC_TEAM_EMOJIS='{"G2":"<:g2:123456789012345678>","FNC":"<:fnc:234567890123456789>"}'
```
